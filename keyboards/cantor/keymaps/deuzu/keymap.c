...
const uint16_t PROGMEM reboot[] = { KC_Y, KC_Q, COMBO_END };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ISRT] = LAYOUT_split_3x6_3(
        //-------------------------------------------------------------------                -------------------------------------------------------------------//
        US_DIAE, KC_Y,         KC_C,         KC_L,         KC_M,         KC_K,               KC_Z, KC_F,         KC_U,         KC_COMMA,     UD_QUOT,      KC_MINS,
        //-------------------------------------------------------------------                -------------------------------------------------------------------//
        ...
        //-------------------------------------------------------------------                -------------------------------------------------------------------//
        US_DGRV, KC_Q,         KC_V,         KC_W,         KC_D,         KC_J,               KC_B, KC_H,         KC_SLSH,      KC_DOT,       KC_X,         US_DCIR,
        //-------------------------------------------------------------------                -------------------------------------------------------------------//
    ...
    [_SYM] = LAYOUT_split_3x6_3(
        ...
        //-------------------------------------------------------------------                 -------------------------------------------------------------------//
        XXXXXXX,    UD_CIRC,    KC_SLSH,    KC_ASTR,    KC_BSLS,    UD_GRV,                   UD_TILD,    KC_DLR,     KC_LCBR,    KC_RCBR,    KC_AT,      XXXXXXX,
        //-------------------------------------------------------------------                 -------------------------------------------------------------------//
                                            KC_ESC,     KC_BSPC,    KC_SPC,                   XXXXXXX,    XXXXXXX,    XXXXXXX
    ),
